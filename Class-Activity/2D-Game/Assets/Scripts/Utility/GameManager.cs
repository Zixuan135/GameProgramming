...
public class GameManager : MonoBehaviour
{
    ...
    public static event Action<int, int> ObjectiveProgressChanged;
    public static event Action GameOverTriggered;
    public static event Action LevelClearedTriggered;
    ...
    {
        enemiesDefeated++;
        ObjectiveProgressChanged?.Invoke(enemiesDefeated, enemiesToDefeat);
    ...
    public static void AddScore(int scoreAmount)
    {
        ...
        UpdateUIElements();
        ScoreChanged?.Invoke(score, instance != null ? instance.highScore : 0);
    }
    ...
    public static void ResetScore()
    {
        ...
        if (instance != null)
        {
            ScoreChanged?.Invoke(score, instance.highScore);
        }
    }
